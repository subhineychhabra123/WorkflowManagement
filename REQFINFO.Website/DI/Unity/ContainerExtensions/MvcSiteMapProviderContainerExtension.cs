...
namespace REQFINFO.Website.DI.Unity.ContainerExtensions
{
        ...
        : UnityContainerExtension
    {
        protected override void Initialize()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "REQFINFO.Website" };
...
// defaultProviderName                new InjectionParameter<string>(string.Empty)
                ));
